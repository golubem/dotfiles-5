Config {
  ...
  , sepChar = "%"
  , alignSep = "}{"
  , template = "  %StdinReader% }{<fc=#8a8a8a> Vol.</fc> %vol%<fc=#e2e2e2> |</fc><fc=#d1d1d1> ⭥ CPU </fc>%multicpu%<fc=#e2e2e2> |</fc><fc=#d1d1d1> ⭦ Mem. </fc>%memory%<fc=#e2e2e2> |</fc><fc=#8a8a8a> ⭫ Bat.</fc>%battery%<fc=#e2e2e2> |</fc><fc=#d1d1d1> ⭧ </fc>%date%<fc=#8a8a8a></fc>        "
}
